  ...
  const handleItemChange = (
    ...
    setPurchase((prev) => {
      ...
      const totalAmount = updatedItems.reduce(
        (sum, item) =>
          sum + (item.purchasePrice || 0) * (item.orderedQuantity || 0),
        0
      );
          ...
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="mt-2 text-sm text-gray-600">
                Create a new purchase order. Fill in the supplier details and
                add purchase items below.
              </p>
            </div>
            <Link
              href="/purchases"
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                  ...
                  <input
                    ...
                    value={purchase.paidAmount === 0 ? "" : purchase.paidAmount}
                    onChange={handleMasterChange}
                    className="w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition duration-200"
                    step="0.01"
                    min="0"
                ...
                <div className="md:col-span-2">
                  ...
                  <p className="mt-1 text-sm text-gray-500">
                    Lock purchase prices to prevent automatic updates from
                ...
                <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-4 mb-4">
                  <div className="flex">
                    ...
                    <p className="text-sm text-yellow-700">
                      Please select a supplier first to add purchase items
                    </p>
                  </div>
                </div>
              )}
                ...
                <div className="bg-blue-50 border border-blue-200 rounded-lg p-4 mb-4">
                  <div className="flex items-center">
                    ...
                    <p className="text-sm text-blue-700">
                      Loading products for selected supplier...
                    </p>
                  </div>
                </div>
              )}
                      ...
                      <select
                        ...
                        onChange={(e) =>
                          handleItemChange(
                            ...
                            "inventory",
                            inventories.find(
                              (inv) => inv.id === Number(e.target.value)
                            )!
                          )
                        }
               ...
               focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
                    ...
                    <div>
                      ...
                      <input
                        type="number"
                        value={(
                          item.orderedQuantity * item.purchasePrice
                        ).toFixed(2)}
