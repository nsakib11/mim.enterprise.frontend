...
import { downloadPurchaseInvoice, getPurchases } from "@/utils/api";
...
export default function InvoiceReport() {
  ...
  const generateInvoice = async () => {
    ...
    try {
      ...
      await downloadPurchaseInvoice(
        parseInt(selectedPurchaseId),
        selectedFormat
      );
          ...
          <div className="space-y-6">
            ...
            <div>
              ...
              {purchases.length === 0 && !loading && (
                <p className="mt-1 text-sm text-gray-500">No purchases found</p>
              )}
            </div>
