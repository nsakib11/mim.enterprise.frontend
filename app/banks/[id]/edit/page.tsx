...
import { getBank, updateBank } from "@/utils/api";
    ...
    return (
      <div className="min-h-screen bg-gray-50 py-8 flex items-center justify-center">
        <div className="text-center">
          ...
          <h3 className="mt-2 text-sm font-medium text-gray-900">Bank not found</h3>
      ...
      <div className="max-w-2xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="mb-8">
          <div className="flex items-center justify-between">
            <div>
              <h1 className="text-3xl font-bold text-gray-900">Edit Bank</h1>
              <p className="mt-2 text-sm text-gray-600">
                Update the bank information below. Make sure all changes are accurate.
              </p>
            </div>
            ...
            <div className="ml-3">
              ...
              <div className="mt-2 text-sm text-blue-700">
                <ul className="list-disc list-inside space-y-1">
                  <li>Ensure bank codes remain unique after changes</li>
                  <li>Update both English and Bengali names for consistency</li>
                  <li>Verify website URL for accuracy</li>
