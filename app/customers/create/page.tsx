          ...
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="mt-2 text-sm text-gray-600">
                Add a new customer to your system. Fill in all the required information below.
              </p>
            </div>
            <Link
              href="/customers"
            ...
            <div className="ml-3">
              ...
              <div className="mt-2 text-sm text-blue-700">
                <ul className="list-disc list-inside space-y-1">
                  <li>Customer codes should be unique for identification</li>
                  <li>Choose appropriate customer type for proper categorization</li>
                  <li>Provide accurate contact information for better communication</li>
                  <li>Include complete address for delivery and billing purposes</li>
