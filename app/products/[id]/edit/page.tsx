...
import { getProduct, updateProduct, getSuppliers, getUnits } from "@/utils/api";
...
export default function EditProduct() {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        setIsLoading(true);
        const [prod, sup, uni] = await Promise.all([
...
const handleSupplierChange = (e: React.ChangeEvent<HTMLSelectElement>) => {
  const selectedSupplier = suppliers.find(s => s.id === Number(e.target.value)) || null;
  setProduct(prev => prev ? { ...prev, supplier: selectedSupplier } as Product : prev);
};

const handleUnitChange = (e: React.ChangeEvent<HTMLSelectElement>) => {
  const selectedUnit = units.find(u => u.id === Number(e.target.value)) || null;
  setProduct(prev => prev ? { ...prev, unit: selectedUnit } as Product : prev);
};
          ...
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="mt-2 text-sm text-gray-600">
                Update product information. Make changes to the fields below as needed.
              </p>
            </div>
            ...
            <div className="ml-3">
              ...
              <div className="mt-2 text-sm text-blue-700">
                <ul className="list-disc list-inside space-y-1">
                  ...
                  <li>Product code and name are required fields</li>
                  <li>Update category information for better organization</li>
                  <li>Verify supplier and unit assignments for accurate tracking</li>
                  <li>Deactivate products that are no longer available</li>
                </ul>
              </div>
            </div>
          </div>
